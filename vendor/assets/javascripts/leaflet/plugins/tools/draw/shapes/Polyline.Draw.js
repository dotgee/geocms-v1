L.Polyline.Draw = L.Handler.Draw.extend({
	...
	_getLabelText: function () {
		...
		if (this._markers.length === 0) {
			...
			if (this._markers.length === 1) {
				labelText = {
					text: 'Cliquer pour continuer le trac\351.',
					subtext: distanceStr
				};
			} else {
				labelText = {
					text: 'Cliquer sur le dernier point pour finir le trac\351.',
					subtext: distanceStr
				};
			}
		}
...
L.Polyline.prototype.distanceInMeters = function () {
